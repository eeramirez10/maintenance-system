...
const ScheduledMaintenanceItem: React.FC<ScheduledMaintenanceItemProps> = ({
  maintenance,
  index,
  handleChange,
  handleDelete,
  ...
  return (
    <li className="py-4 flex flex-col gap-4">
      ...
      <select
        ...
        onChange={(e) =>
          handleChange(index, 'type', e.target.value as 'number' | 'date')
        }
        className="w-full px-4 py-2 border border-gray-300 rounded"
      >
...
export default ScheduledMaintenanceItem;
